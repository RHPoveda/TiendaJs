...
let carrito = [];
const formatearMoneda = new Intl.NumberFormat('es-NI', { style: 'currency', currency: 'NIO' });
            ...
            const plantillaProducto = `
					<div class="carrito__producto-info">
						...
						<div>
							...
							<p class="carrito__producto-propiedades">Tamaño:<span>${productoCarrito.tamaño}</span> Color:<span>${productoCarrito.color
                }</span></p>
						</div>
					</div>
